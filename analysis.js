 ...
 * -------------------
 * Generated by     :: cotrin
 * Generated at     :: Thursday, March 9, 2023 at 8:39 PM Coordinated Universal Time
 * Machine          :: DESKTOP-COTRIN <linux> - Node.js v18.14.0
 * Origin file      :: .//analysis.ts <TypeScript>
 * Destination file :: .//analysis.tago.js
 * -------------------
*/
...
async function startAnalysis(context, scope) {
  ...
  const connector = (_a = scope.find((x) => x.variable === "connector" && x.metadata)) == null ? void 0 : _a.value;
